...
- Web: https://code.claude.com/docs/en/claude-code-on-the-web.md
...
- Skills in SDK: https://code.claude.com/docs/en/agent-sdk/skills.md
- Hooks in SDK: https://code.claude.com/docs/en/agent-sdk/hooks.md
- MCP in SDK: https://code.claude.com/docs/en/agent-sdk/mcp.md
- Permissions in SDK: https://code.claude.com/docs/en/agent-sdk/permissions.md
